...
public class LegalTagUtils {
    public static String createRandomName() {
        return TenantUtils.getTenantName() + "-entity-" + System.currentTimeMillis();
    }

    public static ClientResponse create(String legalTagName, String token) throws Exception {
        ClientResponse response = create("US", legalTagName, "2099-01-25", "Public Domain Data", token);
        System.out.println(String.format("created legal tag: %s", legalTagName));
        return response;
    }
    ...
    public class LegalTagsMock {
        public LegalTagMock[] legalTags;
    }

    public class LegalTagMock {
        public String name;
    }
}
