...
@Slf4j
@ReadingConverter
public enum PostgresObjectToEntityDtoConverter implements Converter<PGobject, EntityDto> {
    INSTANCE;

    private final ObjectMapper objectMapper = new ObjectMapper();

    @Override
    public EntityDto convert(PGobject json) {
        EntityDto converted = null;
        String source = json.getValue();
        try {
            converted = objectMapper.readValue(source, EntityDto.class);
